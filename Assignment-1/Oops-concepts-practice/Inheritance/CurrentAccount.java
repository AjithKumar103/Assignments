...
public class CurrentAccount extends Account{
    ...
    public CurrentAccount(String bankName,String accountNo, String name) {
        super(accountNo, bankName);
        this.name = name;
    }
    // Constructor overload
    public CurrentAccount(String bankName,String accountNo, String name, double overdraftLimit) {
        super(accountNo, bankName);
        this.name = name;
